<template>
  <div class="container-fluid py-5 about bg-primary">
        ...
        <div class="col-lg-7 wow fadeIn" data-wow-delay="0.3s">
          ...
          <div class="row mb-4">
            ...
            <div class="col-lg-6">
              ...
              <h6>
                <i class="fas fa-check-circle me-2 text-secondary"></i>Qualified
                Teacher
              </h6>
            </div>
          </div>
          <a href="" class="btn btn-primary px-5 py-3 btn-border-radius"
            >More Details</a
          >
        </div>
      </div>
